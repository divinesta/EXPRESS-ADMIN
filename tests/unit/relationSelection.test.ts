...
const model = (meta: AdminModelMeta, scope?: FullRegisteredModel["raw"]["scope"]): FullRegisteredModel => ({
   meta,
   raw: { scope },
   resolved: { listDisplay: [meta.displayField], listFilter: [], searchFields: meta.searchableFields, defaultSort: { field: meta.idField, direction: "asc" }, perPage: 25, fieldsets: [], permissions: {} },
});
